<form>
	<fieldset>
		...
		<table width="425" cellpadding="5">
			...
			<tr>
				<td align="right" width="100"><label for="name">Name:</label></td>
				<td><input type="text" name="name" id="name" value="" /></td>
			</tr>
			<tr>
				...
				<td>
					<table align="left">
						<tr>
							...
							<td><input type="text" name="zip" id="zip" style="width:50px;" /></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td align="left" >
					<table width="100%" align="left">
						<tr>
							<td width="100%" style="padding-right:10px;"><input type="text" name="city" id="city" value="" /></td>
							<td>
								<table width="240" align="right">
									<tr>
										...
										<td align="right"><input type="text" name="zip" id="zip" style="width:50px;" /></td>
									</tr>
								</table>
							</td>
						</tr>
			...
			<tr>
				<td align="right"><label for="month">Month:</label></td>
				<td>
					<select id="month">
